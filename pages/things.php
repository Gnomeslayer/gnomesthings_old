		...
		<div class="boxtitle">
			...
			<?php if(isset($_SESSION) && !empty($_SESSION['role'])): ?>
					<?php if($_SESSION['role'] == "Admin"): ?>
						<a href=?page=edit&type=thing&id=<?php echo $blog['id']; ?>><div class="button edit">Edit</div></a>
						<a href=?page=delete&type=thing&id=<?php echo $blog['id']; ?>><div class="button delete">Delete</div></a>
					<?php endif; ?>
				<?php endif; ?><br><br>
